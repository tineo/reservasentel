...
//echo md5("hola");
function sendme($sala, $piso, $sede, $hash, $emails, $bcc)
{
// Create the message
        ...
        ->addPart('<table width="528" border="0" align="left" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					...
					<td bgcolor="#FFFFFF" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;color: #3F3F3F;text-decoration: none;">
					 Hola!<br/>
                       Tienes la sala '.$sala.' del piso '.$piso.' en la sede '.$sede.' reservada, por favor confírmanos si vas a tomar la reserva.<br/>
                       <a href="'.Domino."confirm.php?cc=$hash".'">Confirmar reserva</a>	<a href="'.Domino."confirm.php?cd=$hash".'">Cancelar reserva</a><br/>
				    </td>
					<td bgcolor="#FFFFFF">&nbsp;</td>
				  </tr>
				  <tr>
