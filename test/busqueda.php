...
<tr>
<td height="38" align="left" valign="middle" colspan="4"><span class="mmsbusqueda">Recuerda que según el Reglamento de Reserva de Salas de Reuniones las Cafeterías del piso 18 de PR y del piso 6 de CO SB no se pueden reservar entre 11:30am y 4:30pm, de realizar una reserva el sistema no lo reconocerá.</span></td>
</tr>
<tr>
...
<td width="11">&nbsp;</td>
<td width="167" align="center" valign="middle" bgcolor="#F2F2F2" class="textopequeTITULO"><a href="busqueda-x-salas.php" class="textoLink">Búsqueda por Sala</a></td>
<td width="580">&nbsp;</td>
</tr>
<tr>        
    ...
    <tr>              
      <td valign="middle">
       <select class="gris" id="ddlUbicacion" style="width:210px" onchange="Hora(this.value);">
        ...
        <? 
            /*$ResultUbicacion=mysql_query("select s.idsala, CONCAT_WS(' ',u.nombre,'-','Píso',s.piso,'-',s.nombre) as nombres 
              ...
              <table>
                ...
                <tr>
                  ...
                  <table width="484" border="0" cellpadding="2" cellspacing="1" bgcolor="#E7E7E7">
                    <tr>  
                        <td height="25" colspan="4" valign="middle" class="textopequeTITULO" bgcolor="#FFFFFF">Esta reserva será asignado al siguiente usuario:</td>
                    </tr>
                    <tr>
                        <td width="72" valign="middle" class="textopequeTITULO" style="padding-left:8px;" bgcolor="#FFFFFF">Código</td>  
