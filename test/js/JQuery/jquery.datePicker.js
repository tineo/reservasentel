 ...
 *
 * $Id: jquery.datePicker.js 53 2009-02-19 03:46:27Z kelvin.luck $
 **/
...
//						jQuery(dc('th')).attr({'scope':'col', 'abbr':day, 'title':day, 'class':(weekday == 0 || weekday == 6 ? 'weekend' : 'weekday')}).html(s.showHeader == $.dpConst.SHOW_HEADER_SHORT ? day.substr(0, 1) : day)
					...
					headRow.append(
						jQuery(dc('th')).attr({'scope':'col', 'abbr':day, 'title':day, 'class':(weekday == 0 || weekday == 6 ? 'weekend' : 'weekday')}).html(s.showHeader == $.dpConst.SHOW_HEADER_SHORT ? day : day)
					);
				}
			};
...
//					$('.selectee', this.context).focus();
	...
	// version
	$.dpVersion = '$Id: jquery.datePicker.js 53 2009-02-19 03:46:27Z kelvin.luck $';
