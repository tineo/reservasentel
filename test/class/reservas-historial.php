...
$Ubicacion = new MisReservasHistorial;
...
if($_POST["command"]=='DetalleSalaSeleccion'){
	...
	$Ubicacion->DatosCargar($_POST['pagina'],$_POST['Desde'],$_POST['Hasta'],$_POST['Ubicacion'],$_POST['Piso'],$_POST['Sala'],'AJAX');
...
class MisReservasHistorial{

	function DatosCargar($pagina,$Desde,$Hasta,$Ubicacion,$Piso,$Sala,$Modo){
		global $Utilitario, $idreservaCurrent;
		$Grilla=$this->Listado($pagina,$Desde,$Hasta,$Ubicacion,$Piso,$Sala);
		$Detalle='';
	...
	function DetalleSala($idreserva){
		...
		$result=mysql_query("select s.idsala, s.idubicacion, s.nombre, s.piso, s.capacidad, s.caracteristicas, s.imagen, 
							  ...
							  from salas s, ubicaciones u, reservasant r
		...
		//Complementos
		$resultComple=mysql_query("select c.nombre,leyenda from complementos c, salas_complementos sc, reservasant r
	...
	function Listado($pagina,$Desde,$Hasta,$Ubicacion,$Piso,$Sala){ 
		global $Utilitario, $idreservaCurrent;
	...
	function Eliminar(){
		...
		mysql_query(" UPDATE reservasant set estado='E' WHERE idreserva = ".$_POST['id']);	
		$this->DatosCargar($_POST['pagina'],$_POST['Desde'],$_POST['Hasta'],$_POST['Ubicacion'],$_POST['Piso'],$_POST['Sala'],'AJAX');
	}
