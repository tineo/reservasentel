...
//Le agrega 12 seg.
//var d = new Date(); d.setSeconds(d.getSeconds() + 12);
...
$(".countdown").countdown(new Date(parseInt(Cookies.get("lastcount"))));	
}
...
if(isIE){
$.ajax({url: "http://estacionamientosentel.info/members/logout"});
window.top.close();
}else{
// ==UserScript==
...
$.ajax({url: "http://estacionamientosentel.info/members/logout"}).done(function() {
window.close();								  
        ...
        <td height="135" colspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="42" style="height: 14px"></td>
                <td width="366" style="height: 14px"></td>
        ...
        <td width="925" valign="top">
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="100%" height="37" align="center" valign="middle" class="textopequeTITULO">Todos los derechos reservados Nextel del Per&uacute; SA - 2011</td>
            </tr>
        </table>
        </td>
        <td width="12">&nbsp;</td>
