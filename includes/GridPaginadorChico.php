	...
	function GetRegistros($Contenido,$Idioma='es'){
		...
		$retorno.="	   	<td width='1%' >";
		       ...
		       $retorno .= "</td>";
					...
					$retorno .= "<td width='40%' valign='top'>".$Pagina." ";
		...
		$retorno .=  "		         </table>	";	
		$retorno .=  "				   </td>";
		$retorno .=  "				  <td width='147px' align='right'>". $this->RegistrosAEmpezar = $this->RegistrosAEmpezar + 1 ." - ".$this->MostrarHasta." ".$De." ".$this->NroRegistros." ".$Registros."</td>";
		$retorno .=  "				 </tr>	";	
		$retorno .=  "				</table>";
		$retorno .=  "			   </td>";
		$retorno .=  "			  </tr>";		
